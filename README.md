...
Para inicializar y configurar este proyecto desde cero, se utilizaron los siguientes comandos:

```bash
# 1. Creación del proyecto base con Vite (incluyendo Vue Router)
pnpm create vue@latest weather-frontend-m6

# 2. Ingreso al directorio del proyecto
cd weather-frontend-m6

# 3. Instalación de dependencias por defecto
pnpm install

# 4. Instalación de Bootstrap para el sistema de diseño
pnpm add bootstrap

# 5. Inicialización del servidor de desarrollo local
pnpm dev
```
